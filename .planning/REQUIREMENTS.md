...
- [x] **GRAPH-01**: Build a directed dependency graph from parser output with files as nodes and import references as weighted edges
...
- [x] **INFRA-03**: Serialize parsed graph to `.graft/cache.json` for fast restart with file-hash-based invalidation
...
- [x] **QUAL-03**: Snapshot tests for tree renderer output to catch formatting regressions
